...
# Below 4 lines for comment for 0-255 for 0-1
        ...
        metrics = self.compute_metrics(validation_loader,self.experiment_name+"_mean_params_validation.csv",self.experiment_name+"_logvar_params_validation.csv",self.experiment_name+"_filename_validation.csv") ## CLASSIFICATION_PROBLEM
    ...
    def _train_epoch(self, data_loader, storer, epoch):
        ...
        with trange(len(data_loader), **kwargs) as t:
            for _, (data, _, wtp1, wtp2, wtp3, wtp4, wtp5, make, makemodel, color, firm, region, price, hp, mpg, mpd, filenames, hpwt, space, wt, length, wid, ht, wb, xi_fe, shares, wph) in enumerate(data_loader):
                iter_loss, rec_loss, mi_loss, tc_loss, dw_kl_loss, mse_loss, rsq, latent_kl = self._train_iteration(data, storer, wtp1, wtp2, wtp3, wtp4, wtp5, make, makemodel, color, firm, region, price, hp, mpg, mpd, filenames, hpwt, space, wt, length, wid, ht, wb, xi_fe, shares, wph, epoch+1) 
    ...
    def _train_iteration(self, data, storer, wtp1, wtp2, wtp3, wtp4, wtp5, make, makemodel, color, firm, region, price, hp, mpg, mpd, filenames, hpwt, space, wt, length, wid, ht, wb, xi_fe, shares, wph, epoch):
        """
