##############################################################################
# (b) Model: structured + visual in the demand, BUT instruments from
#            structured char only, random coefficients on [price + structured char].
##############################################################################
...
counterfactual_shares.to_csv('counterfactual_shares3_b.csv',index=False)
...
visual_counterfactual_shares.to_csv('visual_counterfactual_shares3_b.csv',index=False)

uk_product_data.to_csv('exp_uk_product_data_b_3.csv',index=False)
# pd.DataFrame(uk_results_with_supply.xi_fe, columns = ['xi_fe']).to_csv('exp_xi_fe_b_3.csv',index=False)
pd.DataFrame(updated_results.xi_fe, columns = ['xi_fe']).to_csv('exp_xi_fe_b_3.csv',index=False)
