...
uk_product_formulations_with_supply = (
   pyblp.Formulation('1 + hpwt + mpd + space + bodyshape + boxiness + grille_height + grille_width'),
...
counterfactual_simulation = pyblp.Simulation(
        product_formulations = (pyblp.Formulation('1 + hpwt + mpd + space + bodyshape + boxiness + grille_height + grille_width'),
        pyblp.Formulation('1 + prices + hpwt + mpd + space + bodyshape + boxiness + grille_height + grille_width'),
        pyblp.Formulation('1 + log(hpwt) + log(mpg) + log(space) + trend')),
...
counterfactual_shares.to_csv('counterfactual_shares1_d.csv',index=False)
...
visual_counterfactual_shares.to_csv('visual_counterfactual_shares1_d.csv',index=False)

uk_product_data.to_csv('exp_uk_product_data_d_1.csv',index=False)
# pd.DataFrame(uk_results_with_supply.xi_fe, columns = ['xi_fe']).to_csv('exp_xi_fe_d_1.csv',index=False)
pd.DataFrame(updated_results.xi_fe, columns = ['xi_fe']).to_csv('exp_xi_fe_d_1.csv',index=False) 
