...
counterfactual_shares.to_csv('counterfactual_shares1_c.csv',index=False)
...
visual_counterfactual_shares.to_csv('visual_counterfactual_shares1_c.csv',index=False)

uk_product_data.to_csv('exp_uk_product_data_c_1.csv',index=False)
# pd.DataFrame(uk_results_with_supply.xi_fe, columns = ['xi_fe']).to_csv('exp_xi_fe_c_1.csv',index=False)
pd.DataFrame(updated_results.xi_fe, columns = ['xi_fe']).to_csv('exp_xi_fe_c_1.csv',index=False) 
